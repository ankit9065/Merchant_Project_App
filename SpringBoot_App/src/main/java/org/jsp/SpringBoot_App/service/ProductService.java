package org.jsp.SpringBoot_App.service;

import java.util.List;
import java.util.Optional;
import org.jsp.SpringBoot_App.dao.MerchantDao;
import org.jsp.SpringBoot_App.dao.ProductDao;
import org.jsp.SpringBoot_App.dto.Merchant;
import org.jsp.SpringBoot_App.dto.Product;
import org.jsp.SpringBoot_App.dto.ResponseStructure;
import org.jsp.SpringBoot_App.exception.MerchantNotFoundException;
import org.jsp.SpringBoot_App.exception.ProductNotFoundException;
...
public class ProductService {
	...
	public ResponseEntity<ResponseStructure<Product>> saveProduct(Product product, int merchant_id) {
		...
		if (recMerchant.isPresent()) {
			...
			merchantDao.saveMerchant(merchant);// Updating merchant
